...
;(function ($, window, undefined) {
			...
			$.Baraja.prototype = {
						...
						_setDefaultFanSettings: function _setDefaultFanSettings() {
						...
						_validateDefaultFanSettings: function _validateDefaultFanSettings(settings) {
						...
						_setStack: function _setStack($items) {
						...
						_updateStack: function _updateStack($el, dir) {
						...
						_resetTransition: function _resetTransition($el) {
						...
						_setOrigin: function _setOrigin($el, x, y) {

									$el.css('transform-origin', x + '% ' + y + '%');
						},
						_setTransition: function _setTransition($el, prop, speed, easing, delay) {
						...
						_applyTransition: function _applyTransition($el, styleCSS, fncomplete, force) {
						...
						_move2front: function _move2front($item) {
						...
						_close: function _close(callback, $item) {
						...
						_allowAction: function _allowAction() {

									return this.itemsCount > 1;
						},
						_prepare: function _prepare(callback) {
						...
						_dispatch: function _dispatch(action, args) {
